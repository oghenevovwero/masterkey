...
export default function Trade() {
  ...
  return <div className="mx-10">
    <div className="rounded-[12px] bg-[#6A3F9F] text-[12px] p-5 text-white">
      <div className="mb-5 font-light text-lg">Spotlight listings</div>
      <div className="mb-5 font-light text-lg">Total swaps today</div>
      <div className="mb-5 font-light text-xl">$45,500,120</div>
      <div className="relative w-3">
        <div>
          <svg width="300" height="23" viewBox="0 0 535 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="300" height="23" rx="11.5" fill="black" />
          </svg>
        </div>
        <div className="absolute top-0 left-[150px]">
          <svg width="300" height="23" viewBox="0 0 535 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="300" height="23" rx="11.5" fill="white" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="relative flex-grow my-5">
      <input className="p-5 w-full border-[1px] rounded-md border-white bg-[#61FFCB]" placeholder="Search" />
      <div className="absolute top-5 right-5 focus:hidden">
